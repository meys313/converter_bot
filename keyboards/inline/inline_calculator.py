...
default_calculator = InlineKeyboardMarkup(row_width=5,
                                          inline_keyboard=[
                                              ...
                                              [
                                                  ...
                                                  InlineKeyboardButton(text="C", callback_data=callback.new(value='delete')),
                                                  InlineKeyboardButton(text='❌', callback_data=callback.new(value='clear')),
                                              ...
                                              [
                                                  InlineKeyboardButton(text='Результат', callback_data=callback.new(value='=')),
                                              ]
